...
public class UtilNumber {
     ...
     * @return
     */
    public static Integer ceilPage(Integer listSize, Integer viewSize){
    	BigDecimal a = new BigDecimal(listSize.intValue()).setScale(4);
    	BigDecimal b = new BigDecimal(viewSize).setScale(4);
    	BigDecimal r = a.divide(b, 4);
    	double x = Math.ceil(r.doubleValue());
    	return new BigDecimal(x).intValue();
    }
    
    public static BigDecimal round(BigDecimal number){
    	return number.setScale(DEFAULT_BD_SCALE, DEFAULT_BD_ROUNDING_MODE);
    }
    
    public static BigDecimal round(BigDecimal number, int roundingMode){
    	return number.setScale(DEFAULT_BD_SCALE, roundingMode);
    }
    
    public static BigDecimal round(BigDecimal number, int scale, int roundingMode){
